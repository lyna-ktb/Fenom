<div class="col-4@sm padding-left-lg">
  ...
  <div class="tabs js-tabs">
    <ul class="flex flex-wrap gap-sm js-tabs__controls">
      <li class="tabs__control">
        <p class="text-line-through text-sm ">80,00€</p>
      </li>

      <li class="tabs__control">
        <p class="text-sm color-white bg-black">-10%</p>
      </li>

      <li class="tabs__control">
        <p class="color-contrast-high">75,00€</p>
      </li>
    </ul>
  </div>

  <p class="font-medium text-sm margin-top-sm">TAILLE</p>

  <div class="btns gap- font-medium text-sm margin-top-sm">
    <button class="btns__btn btns__btn--selected ">40</button>
    <button class="btns__btn">41</button>
    <button class="btns__btn">42</button>
    <button class="btns__btn">42.5</button>
    <button class="btns__btn ">43</button>
    <button class="btns__btn ">44</button>
  </div>
  ...
  <div class="flex padding-top-md">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" height="25" width="33">
    ...
    <p class="text-sm font-semibold">Livraison en France métropolitaine</p>
  </div>
  ...
  <div class="flex padding-top-xs">
    ...
    <p class="text-sm font-semibold">Expédition le jour meme jusqu'à 13h</p>
  </div>
  ...
  <div class="flex padding-top-xs">
    ...
    <p class="text-sm font-semibold">Paiement 100% sécurisé</p>
  </div>

  <div class="padding-top-md">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60.01 31.3" heighht="50" width="50">
      <title>logo-nike</title>
      <g>
        <polygon points="14.66 9.07 14.19 16.27 18.33 16.27 24.43 0 20.59 0 17.85 7.3 18.32 0 14.23 0 8.13 16.27 11.97 16.27 14.66 9.07" />
        <polygon points="22.68 16.27 28.78 0 24.93 0 18.83 16.27 22.68 16.27" />
        <path d="M59.58,9.74,42.44,14.38l.45-1.27H38.41l1.47-3.94h3.7l1.14-3H41l1.26-3.43h3.9l1-2.71H35.48l-4,4.88L33.31,0h-3.9L23.36,16.27h3.85l2.58-6.8.18,6.8h5.54L15.09,21.79c-5.63,1.58-12-1.86-7.4-11.13C2.31,17-2.76,25.37,1.72,29.23s9.76,1.53,13.46.05S59.75,10.06,59.75,10.06C60.15,9.86,60.07,9.61,59.58,9.74Zm-26-3L39.35.32,33.78,15.18Z" />
      </g>
    </svg>
  </div>
</div>
